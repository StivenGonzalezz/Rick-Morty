...
const Article = (props) => {
  return (
    <article class="mb-[15px] w-[40%] h-[30%] flex border-[4px] rounded-xl border-solid border-white bg-#262c3a items-center hover:scale-105 transition-all ease-in hover:backdrop-blur-sm">
